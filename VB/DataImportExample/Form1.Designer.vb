...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            AddHandler Me.btnImportArrayList.Click, New System.EventHandler(AddressOf Me.btnArrayList_Click)
            ' 
            ' btnUseConverter
            ' 
            ...
            AddHandler Me.btnUseConverter.Click, New System.EventHandler(AddressOf Me.btnUseConverter_Click)
            ' 
            ' btnUseFields
            ' 
            ...
            AddHandler Me.btnUseFields.Click, New System.EventHandler(AddressOf Me.btnUseFields_Click)
            ' 
            ' btnUseOptions
            ' 
            ...
            AddHandler Me.btnUseOptions.Click, New System.EventHandler(AddressOf Me.btnUseOptions_Click)
            ' 
            ' btnImportObject
            ' 
            ...
            AddHandler Me.btnImportObject.Click, New System.EventHandler(AddressOf Me.btnImportObject_Click)
            ' 
            ' btnImportList
            ' 
            ...
            AddHandler Me.btnImportList.Click, New System.EventHandler(AddressOf Me.btnImportList_Click)
            ' 
            ' btnImportArray
            ' 
            ...
            AddHandler Me.btnImportArray.Click, New System.EventHandler(AddressOf Me.btnImportArray_Click)
            ' 
            ' btnImportDataTable
            ' 
            ...
            AddHandler Me.btnImportDataTable.Click, New System.EventHandler(AddressOf Me.btnImportDataTable_Click)
            ' 
            ' splitterControl1
            ' 
...
#End Region
        ...
        Private btnImportDataTable As DevExpress.XtraEditors.SimpleButton

        Private btnImportArray As DevExpress.XtraEditors.SimpleButton

        Private btnImportList As DevExpress.XtraEditors.SimpleButton

        Private btnImportObject As DevExpress.XtraEditors.SimpleButton

        Private btnUseOptions As DevExpress.XtraEditors.SimpleButton

        Private spreadsheetDockManager1 As DevExpress.XtraSpreadsheet.SpreadsheetDockManager

        Private btnUseFields As DevExpress.XtraEditors.SimpleButton

        Private btnUseConverter As DevExpress.XtraEditors.SimpleButton

        Private btnImportArrayList As DevExpress.XtraEditors.SimpleButton
